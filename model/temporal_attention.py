...
class TemporalAttentionLayer(torch.nn.Module):
  ...
  def __init__(self, n_node_features, n_neighbors_features, n_edge_features, n_edge_motif_features,
               time_dim, output_dimension, n_head=2, dropout=0.1):
    ...
    self.key_dim = n_neighbors_features + time_dim + n_edge_features + n_edge_motif_features
  ...
  def forward(self, src_node_features, src_time_features, neighbors_features,
              neighbors_time_features, edge_features, edge_motif_features, neighbors_padding_mask):
    """
    ...
    key = torch.cat([neighbors_features, edge_features, edge_motif_features, neighbors_time_features], dim=2)
